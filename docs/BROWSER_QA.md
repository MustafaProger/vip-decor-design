...
Дата: 2026-09-12T11:13:15.413Z. Адрес: http://127.0.0.1:5180. Chrome 152.0.7977.83.
Проверки маршрутов и Axe выполнены 2026-09-12T11:11:02.041Z; затем отдельно повторены сценарии взаимодействия.

Проверено 41 исходных страниц и 36 категорий (адреса категорий входят в исходные страницы), а также 15 дополнительных маршрутов. Всего 56 уникальных маршрутов на 320 и 1440 px. Семь основных страниц также проверены на 390, 768, 1024 и 1920 px.

Проверки страниц: 140/140 пройдено. Axe WCAG A/AA: 12/12 без нарушений. Сценарии: 5/5 пройдено.
