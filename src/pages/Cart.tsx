            ...
            {checkout && (
              <section className="checkout-panel">
                ...
                <p className="checkout-notice">
                  Сохраним заявку с выбранными товарами. Наличие и итоговую
                  стоимость нужно подтвердить с менеджером. Оплата здесь не
                  списывается.
                </p>
                {result ? (
                    ...
                    {delivery === "Курьер" && (
                      <label>
                        ...
                        <span className="fine-print">
                          ...
                          стоимость согласовывается с нашей командой и не
                          включена в сумму.
                        </span>
                      </label>
                    )}
